...
import argparse
from get_embedding_function import get_embedding_func
...
PROMPT_TEMPLATE = """
You are a chatbot named Systems Bot The users of this are Systems engineers that are using this for researching Systems Engineering 
...
Answer the questions as a systems engineer would based on the above context: {question}
"""
